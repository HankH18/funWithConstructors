...
Student.prototype.learn = function(knowledgeGained) {
	this.knowledge += knowledgeGained
}
...
var Safe = function(secretData,instanceKey) {

}

Safe.prototype.unlock = function(key) {
	if(Object.is(Safe.instanceKey, key)){
			return Safe.secretData
		}
		else{
			return null
		}
